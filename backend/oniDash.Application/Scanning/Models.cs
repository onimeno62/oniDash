...
public sealed record ScanProgress(Guid ScanId, Guid LibraryId, Guid SourceId, string SourceName, ScanStatus Status,
    ...
    long FilesUnchanged, long FilesMarkedMissing, DateTimeOffset StartedAtUtc, DateTimeOffset? CompletedAtUtc,
    string? Error, IReadOnlyList<ScanDiagnostic>? Diagnostics = null);
