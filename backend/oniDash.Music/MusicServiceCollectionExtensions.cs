...
public static class MusicServiceCollectionExtensions
{
    ...
    public static IEndpointRouteBuilder MapMusicEndpoints(this IEndpointRouteBuilder app) => MusicEndpoints.MapMusicEndpoints(app).MapMusicEngagementEndpoints().MapMusicPlaylistEndpoints().MapMusicMetadataEndpoints();
