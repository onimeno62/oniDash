...
export default function App() { return <PlayerProvider><Routes><Route element={<AppShell />}><Route index element={<DashboardPage />} /><Route path="library" element={<LibraryPage />} /><Route path="music" element={<MusicPage />} /><Route path="music/playlists" element={<PlaylistsPage />} /><Route path="music/insights" element={<MusicInsightsPage />} /><Route path="movies" element={<MoviesPage />} /><Route path="search" element={<SearchPage />} /><Route path="health" element={<HealthPage />} /><Route path="settings" element={<SettingsPage />} /><Route path="*" element={<NotFoundPage />} /></Route></Routes></PlayerProvider>; }
