...
export const NAV_ITEMS: NavItem[] = [
  ...
  { to: '/music', label: 'Music', description: 'Unified music dashboard: library, playlists, favorites, history and insights.', icon: MusicIcon },
...
export function pageTitleFor(pathname: string): string { return TITLES.get(pathname) ?? (pathname.startsWith('/music') ? 'Music' : 'oniDash'); }
